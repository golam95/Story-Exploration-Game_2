package com.funtolearn.model;

public class Strore_userInfo {
	private int user_id;
	private String user_name;
	private String user_completemodule;
	private String selecttype;

	public Strore_userInfo(int user_id, String user_name, String user_completemodule, String selecttype) {
		super();
