...
public class UserProgress extends JDialog implements MouseListener, ActionListener {
	...
	JLabel lbl_story1 = new JLabel("Story_1");
	...
	public UserProgress(JFrame parent) {
	...
	public void showReport() {
		...
		lbl_complete.setBounds(130, 15, 100, 30);
		lbl_Total.setBounds(270, 15, 100, 30);

		lbl_story1.setBounds(20, 46, 240, 30);

		lbl_com1.setBounds(160, 46, 40, 30);

		lbl_tot1.setBounds(280, 46, 40, 30);

		bnt_close.setBounds(45, 162, 260, 25);
		...
		lst_name.setBackground(Color.decode("#BE920D"));
		...
		bnt_close.setBackground(Color.pink);
