...
public class userInfo extends JDialog {
	...
	public userInfo(JFrame parent, String type, String complete) {
	...
	public void createEnrollpanel() {
		try {
			...
			btn_ok.setBackground(Color.decode("#FF6000"));
			btn_ok.setFont(font);
					...
					if (name.equals("")) {
						...
						try {
							if (infoimp.check_playerName(name) == true) {
								...
								infoimp.add_playerInfo(new Strore_userInfo(0, name, select_complete, select_type));
								txt_name.setText("");
								visablefalse();
							}
